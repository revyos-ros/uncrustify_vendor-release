## uncrustify_vendor (jazzy) - 3.0.1-1

The packages in the `uncrustify_vendor` repository were released into the `jazzy` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r jazzy uncrustify_vendor --override-release-repository-push-url git@github.com:revyos-ros/uncrustify_vendor-release.git` on `Mon, 23 Jun 2025 05:31:41 -0000`
